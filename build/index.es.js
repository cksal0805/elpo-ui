...
function Button(_a) {
    ...
    return (React.createElement(StyledButton, { disabled: disabled, theme: theme, color: color, animation: animation, size: size, mobileViewsize: mobileViewButton === null || mobileViewButton === void 0 ? void 0 : mobileViewButton.viewSize, onClick: onClick },
        mobileViewButton &&
        ...
        React.createElement("span", { className: "init" },
            startIcon && React.createElement(StartIcon, null, startIcon),
            React.createElement("span", null, children),
            endIcon && React.createElement(EndIcon, null, endIcon))));
}
