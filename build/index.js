...
var themeStyle = styled.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var theme = _a.theme, color = _a.color, animation = _a.animation;
    if (theme === 'fill') {
        return styled.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n        border: 1px solid ", ";\n        background-color: ", ";\n        color: white;\n        &:hover {\n          background-color: ", ";\n          transition: 0.6s;\n        }\n      "], ["\n        border: 1px solid ", ";\n        background-color: ", ";\n        color: white;\n        &:hover {\n          background-color: ", ";\n          transition: 0.6s;\n        }\n      "])), buttonTheme.color[color], buttonTheme.color[color], animation && curriedDarken(0.06, buttonTheme.color[color]));
    }
    if (theme === 'outlined') {
        return styled.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        border: 1px solid ", ";\n        background-color: transparent;\n        color: ", ";\n        &:hover {\n          background-color: ", ";\n          transition: 0.6s;\n        }\n      "], ["\n        border: 1px solid ", ";\n        background-color: transparent;\n        color: ", ";\n        &:hover {\n          background-color: ", ";\n          transition: 0.6s;\n        }\n      "])), buttonTheme.color[color], buttonTheme.color[color], animation && curriedLighten(0.37, buttonTheme.color[color]));
    }
    if (theme === 'text') {
        return styled.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        border: none;\n        background-color: transparent;\n        color: ", ";\n        &:hover {\n          background-color: ", ";\n          transition: 0.6s;\n        }\n      "], ["\n        border: none;\n        background-color: transparent;\n        color: ", ";\n        &:hover {\n          background-color: ", ";\n          transition: 0.6s;\n        }\n      "])), buttonTheme.color[color], animation && curriedLighten(0.37, buttonTheme.color[color]));
    }
});
var mobileStyle = styled.css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
